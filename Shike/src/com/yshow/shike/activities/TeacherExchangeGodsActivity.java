 ...
 * 兑换商品
 */
public class TeacherExchangeGodsActivity extends BaseActivity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        imgLoadOption = Net_Servse.getInstence().Picture_Shipei(R.drawable.xiaoxi_moren);
        instance = ImageLoader.getInstance();
        pointText = (TextView) findViewById(R.id.xuefen_point);
    ...
    class MyListAdapter extends BaseAdapter {
        ...
        public View getView(final int id, View arg1, ViewGroup arg2) {
            ...
            jifen.setText(lists.get(id).getPoints());
            Button button = (Button) view.findViewById(R.id.goods_list_item_duihuan);
            instance.displayImage(tgoods.getIcon(), commodity, imgLoadOption);
