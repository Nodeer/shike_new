...
public class Activity_Select_Tea extends BaseActivity implements OnClickListener {
    ...
    private void initData() {
        ...
        if (tiwen_teacher_Id != null && tea_name != null && tiwen_subject_id != null && sub_name != null && tea_img != null) {//如果是从我的老师提问过来的
            ...
            onlineTeaTextview.setTextColor(R.color.white);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.my_tea_button:
                intent = new Intent(context, Activity_SelectTeacher.class);
        ...
        SKAsyncApiController.ChongFa(isTry_questionId, teacherId,
                new MyAsyncHttpResponseHandler(this, true) {
                    ...
                    public void onSuccess(String json) {
                        ...
                        boolean isSuccess = SKResolveJsonUtil.getInstance().resolveIsSuccess(json, Activity_Select_Tea.this);
                        if (isSuccess) {
                            Activity_Select_Tea.this.finish();
                        }
                    }
                });
    }
