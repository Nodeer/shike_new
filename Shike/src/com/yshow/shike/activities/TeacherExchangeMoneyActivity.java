 ...
 * 兑换现金
 */
public class TeacherExchangeMoneyActivity extends Activity {
    ...
    private void initData() {
        ...
        title.setText("兑换现金");
        money_text = (TextView) findViewById(R.id.xuefen_point);
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                ...
                case R.id.bt_jifen_set:
                    ...
                    Dialog.intent(context, TeacherBankEditActivity.class, bun);
                    break;
    ...
    private void MyShiKeInfo(String uid) {
        SKAsyncApiController.User_Info(uid, new MyAsyncHttpResponseHandler(this, true) {
            public void onSuccess(String json) {
                ...
                money_text.setText(my_teather.getPoints());
                try {
