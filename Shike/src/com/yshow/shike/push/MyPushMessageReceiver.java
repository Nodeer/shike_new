...
public class MyPushMessageReceiver extends FrontiaPushMessageReceiver {
    ...
    public void onBind(Context context, int errorCode, String appid,
        ...
        SharePreferenceUtil.getInstance().putString("push_userid", userId);
    ...
    public void onNotificationClicked(Context context, String title,
        ...
        if (instance.getStudent() == null) {
            ...
            if (instance.isTeacher()) {
                intent.setClass(context.getApplicationContext(), Teather_Main_Activity.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                context.getApplicationContext().startActivity(intent);
            } else {
                intent.setClass(context.getApplicationContext(), Student_Main_Activity.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                context.getApplicationContext().startActivity(intent);
            }
        }
