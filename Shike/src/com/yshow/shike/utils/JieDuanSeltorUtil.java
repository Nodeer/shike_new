...
public class JieDuanSeltorUtil implements DialogInterface.OnClickListener {
    @SuppressWarnings("unused")
    private Context context;
    private Builder alertDialog;
    private JieduanSeltorUtilButtonOnclickListening listening;
    private ArrayList<SkClasses> sKArea = null;
    ...
    public JieDuanSeltorUtil(Context context, final ArrayList<SkClasses> sKArea) {
        this.sKArea = sKArea;
    ...
    private void ininSeltorInfo() {
        ...
        SkClasses skArea2 = sKArea.get(currentItem);
        seltotText = skArea2.getName();
        areaId = skArea2.getId();
    }

    public void setJieduanSeltorUtilButtonOnclickListening(
            JieduanSeltorUtilButtonOnclickListening listening) {
    ...
    public interface JieduanSeltorUtilButtonOnclickListening {
    ...
    private class CountryAdapter extends AbstractWheelTextAdapter {
        private ArrayList<SkClasses> sKArea;

        protected CountryAdapter(Context context, ArrayList<SkClasses> sKArea) {
