...
import com.yshow.shike.entity.Banks;
...
public class BankSeltorUtil implements DialogInterface.OnClickListener {
    @SuppressWarnings("unused")
    private Context context;
    private Builder alertDialog;
    private BankSeltorUtilButtonOnclickListening listening;
    private ArrayList<Banks> sKArea = null;
    ...
    public BankSeltorUtil(Context context, final ArrayList<Banks> sKArea) {
        this.sKArea = sKArea;
    ...
    private void ininSeltorInfo() {
        ...
        Banks skArea2 = sKArea.get(currentItem);
        seltotText = skArea2.getName();
        areaId = skArea2.getId();
    }

    public void setBankSeltorUtilButtonOnclickListening(
            BankSeltorUtilButtonOnclickListening listening) {
    ...
    public interface BankSeltorUtilButtonOnclickListening {
    ...
    private class CountryAdapter extends AbstractWheelTextAdapter {
        private ArrayList<Banks> sKArea;

        protected CountryAdapter(Context context, ArrayList<Banks> sKArea) {
